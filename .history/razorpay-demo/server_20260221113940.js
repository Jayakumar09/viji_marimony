...
// ------------------------
// Allows any http://localhost:<port> origin dynamically
...
💡 CORS dynamically allows any localhost frontend port.
💻 Your frontend can be on any http://localhost:<port> and requests will work.
    `);
  });
});