        ...
        {error && (
          <div className="mb-3 p-2 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center">
              <svg className="w-3 h-3 text-red-500 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="bg-white p-2 rounded-lg mb-2">
              <div className="grid grid-cols-2 gap-1.5 text-xs">
                <div>
                  <p className="text-[10px] text-gray-500">Account Holder</p>
                  <p className="font-medium text-xs">{bankTransferDetails.bankDetails.accountHolderName}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500">Bank Name</p>
                  <p className="font-medium text-xs">{bankTransferDetails.bankDetails.bankName}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500">Account Number</p>
                  <p className="font-medium text-xs">{bankTransferDetails.bankDetails.accountNumber}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500">IFSC Code</p>
                  <p className="font-medium text-xs">{bankTransferDetails.bankDetails.ifscCode}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500">Amount</p>
                  <p className="font-medium text-green-600 text-xs">₹{bankTransferDetails.amount}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500">Reference ID</p>
                  <p className="font-medium text-purple-600 text-xs">{bankTransferDetails.referenceId}</p>
                </div>
              </div>
            </div>
            <div className="bg-yellow-50 p-2 rounded-lg">
              <h4 className="font-medium text-yellow-800 text-[10px] mb-0.5">Instructions:</h4>
